   ...
   return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-indigo-900 px-6 py-10">
         <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-40 right-20 h-96 w-96 rounded-full bg-gradient-to-br from-emerald-600/10 to-teal-600/10 blur-3xl"></div>
            <div className="absolute bottom-40 left-20 h-96 w-96 rounded-full bg-gradient-to-br from-blue-600/10 to-cyan-600/10 blur-3xl"></div>
         </div>
