export default function LoadingToursPage() {
   return (
      <main className="min-h-screen bg-gradient-to-br from-black via-gray-950 to-gray-900 px-6 py-12">
         ...
         <section className="relative mx-auto grid max-w-7xl grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-8 px-4">
